            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php if ($user->level == 1) : ?>
                        ...
                        <div class="col-lg-6 mb-3">
                            <label for="user_key" class="form-label">المفتاح</label>
                        ...
                        <div class="col-lg-6 mb-3">
                            <label for="duration" class="form-label">عدد الايام<small class="text-muted"></small></label>
                        ...
                        <div class="col-lg-6 mb-3">
                            <label for="max_devices" class="form-label">عدد الاجهزة</label>
                    ...
                    <div class="col-md-6 mb-2" id="col-status">
                        <label for="status" class="form-label">صلاحيات المفتاح</label>
                    ...
                    <div class="col-md-6 mb-3">
                        <label for="registrator" class="form-label">المالك</label>
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="expired_date" class="form-label">التاريخ<?= !$key->expired_date ? '' : ''  ?></label>
                    ...
                    <div class="col-lg-12 mb-3">
                        <label for="devices" class="form-label"> الاجهزة <span class="bg-dark text-white px-1 rounded maxDev"><?= $key_info->total ?>/<?= $key->max_devices ?></span> <small class="text-muted"></small></label>
                    ...
                    <div class="col-lg-6">
                        <button class="btn btn-outline-dark btnUpdate" disabled>تحديث المعلومات</button>
                    </div>
                    <?= form_close() ?>
